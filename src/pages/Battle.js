...
const Battle = (props) => {
  ...
  const [pokemonAgainstHp, setPokemonAgainstHp] = useState(
  ...
  const [pokemonFirstHp, setPokemonFirstHp] = useState(
    pokemon.stats[0].base_stat
  );
  ...
  function doDamage() {
    ...
    let hpResult =
      pokemonAgainstHp - Math.abs(pokemonAttack - pokemonAgainstDefense);
        ...
        <div className="battleContainer">
          <div className="pokemonAgainstContainer">
            <div className="pokemon-stats">
              ...
              <div className="attack-button">
                <button onClick={() => takeDamage()}>Atacar</button>
              </div>
            </div>
            ...
            <div className="pokemon-state">
              ...
              <div className="hpBar">
                <div
                  style={{ width: pokemonActualAgainstHp + "%" }}
                  className="hpActual"
                ></div>
              </div>
            </div>
            ...
            <img
              ref={pokeAgainstImgEl}
              src={pokemonAgainst.sprites.front_default}
            />
          </div>
          ...
          <div className="pokemonContainer">
            ...
            <div className="pokemon-stats">
              ...
              <div className="attack-button">
                <button onClick={() => doDamage()}>Atacar</button>
              </div>
            </div>
